...
// No Page hero example
(function(){
	'use strict';
	// Dynamic hero banner image
	var $img = $('.page-banner .banner-image .javelin_textItem img'),
	    $src = $img.attr('src'),
	    $banner = $('.page-banner .banner-image'),
	    $admin = $('.is-admin'),
	    $javelinRegion = $('.page-banner .banner-image .javelin_region'); // gap will appear if whole region isn't removed - using jQuery selector because ie 11 -9 does not support .remove() in vanilla js
